...
public class ThucHanhCRM extends BaseTest {
    ...
    public void testAddNewCustomer() {
        ...
        Assert.assertEquals(WebUI.getElementAttribue(By.xpath("//input[@id='company']"), "value"), CUSTOMER_NAME, "The CUSTOMER NAME not match.");
        Assert.assertEquals(WebUI.getElementAttribue(By.xpath("//input[@id='vat']"), "value"), "10", "The VAT not match.");
        Assert.assertEquals(WebUI.getElementAttribue(By.xpath("//input[@id='phonenumber']"), "value"), "0123456789", "The PHONE not match.");
        Assert.assertEquals(WebUI.getElementAttribue(By.xpath("//input[@id='website']"), "value"), "https://crm.anhtester.com/admin/clients/client", "The WEBSITE not match.");
